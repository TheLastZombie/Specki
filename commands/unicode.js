if (args && args != "") {
	...
	for (i = 0; i < args.join(" ").replace(/[\x00-\x1F\x7F-\x9F]/g, "").length; i++) {
		for (j = 0; j < 29; j++) {
			var code = require("unicode/category/" + ["Cc", "Cf", "Cn", "Co", "Cs", "Ll", "Lm", "Lo", "Lt", "Lu", "Mc", "Me", "Mn", "Nd", "Nl", "No", "Pc", "Pd", "Pe", "Pf", "Pi", "Po", "Ps", "Sc", "Sk", "Sm", "So", "Zl", "Zp", "Zs"][j])[args.join(" ").replace(/[\x00-\x1F\x7F-\x9F]/g, "").charCodeAt(i)];
			if (code) {
