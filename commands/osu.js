                  ...
                  message.channel.send({
                    embed: {
                      ...
                      fields: [
                        ...
                        {
                          name: 'Best',
                          value: ((best) || '❎ No best beatmaps found!')
                        },
                        {
                          name: 'Recent',
                          value: ((recent) || '❎ No recent beatmaps found!')
                        }
                      ]
                    }
                  })
